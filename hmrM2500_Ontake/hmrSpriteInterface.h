...
#define HMR_SPRITEINTERFACE_INC 107
#
/*
===hmrSpriteInteface===
注意点：カメラの電源ピンを下げてもuartを有効にしているとuartの線から中途半端に電圧が与えられて完全に電源が落ちないので注意が必要

SpriteJpegCmrの処理に必要な関数群をまとめたもの
hmrSpriteInterface:v1_05/130907 iwahori
	JPEGカメラモジュールが若干新しくなったことによる通信の微修正を行う。
	写真サイズのコマンドが変わり、変更後にリセット不要になった。
